...
@Component({
  selector: 'app-cgsvg',
  templateUrl: './cgsvg.component.html',
  styleUrls: ['./cgsvg.component.scss']
})
export class CgsvgComponent implements OnInit {

  public cgsvg: FormGroup; //add  FormGroup 
  ...
  constructor(private fb: FormBuilder, private ds: DataService) { 
    ...
    this.cgsvg = this.fb.group({ //definition to cons            
    });  
