...
@Component({
  selector: 'app-deptdifentry',
  templateUrl: './deptdifentry.component.html',
  styleUrls: ['./deptdifentry.component.scss']
})
export class DeptdifentryComponent implements OnInit {
  ...
  public user_id: any; public message: any; public districts: any = [];
  ...
  ngOnInit(): void 
  {
    ...
    this.getdistrict();         
    this.getallyears();
    this.message = ""; this.selectedyear = ""; this.districtid="";
  ...
  onDistrictSelected(event: any) 
  {
    ...
    this.getdistrictname(this.districtid); 
  }
