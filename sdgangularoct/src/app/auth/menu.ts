export const MENUITEMS: any = {
    ...
    3: [
        { state: '/department/dashboard', type: 'link', name: 'Department Dashboard', icon: 'dashboard' },
    ],
    4: [
        { state: '/district/districtdashboard', type: 'link', name: 'District Dashboard', icon: 'dashboard' },
        { state: '/district/districtdifentry', type: 'link', name: 'DIF Entry', icon: 'keyboard' },
        { state: '/district/districttemplate', type: 'link', name: 'Template Download', icon: 'download' },
        { state: '/district/districtuploadtemplate', type: 'link', name: 'Upload File', icon: 'upload' },
        { state: '/district/districtnotification', type: 'link', name: 'Notification', icon: 'notifications' },
    ],
    5: [
        { state: '/district/districtdashboard', type: 'link', name: 'District Dashboard', icon: 'dashboard' },
    ]
